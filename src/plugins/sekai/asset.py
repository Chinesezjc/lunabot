...
class RegionMasterDataCollection:
    ...
    def __init__(self, region: str):
        ...
        self.practice_tickets                                               = RegionMasterDataWrapper(region, "practiceTickets")
        self.skill_practice_tickets                                         = RegionMasterDataWrapper(region, "skillPracticeTickets")
        self.mysekai_housing_competitions                                   = RegionMasterDataWrapper(region, "mysekaiHousingCompetitions")
        self.custom_profile_text_colors                                      = RegionMasterDataWrapper(region, "customProfileTextColors")
        self.custom_profile_text_fonts                                       = RegionMasterDataWrapper(region, "customProfileTextFonts")
        self.custom_profile_shape_resources                                  = RegionMasterDataWrapper(region, "customProfileShapeResources")
        self.custom_profile_player_info_resources                            = RegionMasterDataWrapper(region, "customProfilePlayerInfoResources")
        self.custom_profile_general_background_resources                     = RegionMasterDataWrapper(region, "customProfileGeneralBackgroundResources")
        self.custom_profile_story_background_resources                       = RegionMasterDataWrapper(region, "customProfileStoryBackgroundResources")
        self.custom_profile_member_standing_picture_resources                = RegionMasterDataWrapper(region, "customProfileMemberStandingPictureResources")
        self.custom_profile_collection_resources                             = RegionMasterDataWrapper(region, "customProfileCollectionResources")
        self.custom_profile_etc_resources                                    = RegionMasterDataWrapper(region, "customProfileEtcResources")
        self.custom_profile_character_icon_resources                         = RegionMasterDataWrapper(region, "customProfileCharacterIconResources")
        self.custom_profile_material_resources                               = RegionMasterDataWrapper(region, "customProfileMaterialResources")
        self.custom_profile_user_interface_icon_resources                    = RegionMasterDataWrapper(region, "customProfileUserInterfaceIconResources")
        self.omikujis                                                        = RegionMasterDataWrapper(region, "omikujis")
        self.unit_story_episode_groups                                       = RegionMasterDataWrapper(region, "unitStoryEpisodeGroups")
...
MasterDataManager.set_index_keys("materials", ['id', 'seq'])
MasterDataManager.set_index_keys("boostItems", ['id', 'seq'])
MasterDataManager.set_index_keys("eventItems", ['id', 'eventId'])
MasterDataManager.set_index_keys("practiceTickets", ['id', 'characterId'])
MasterDataManager.set_index_keys("skillPracticeTickets", ['id', 'characterId'])
MasterDataManager.set_index_keys("gachaTickets", ['id', 'seq'])
MasterDataManager.set_index_keys("gachaCeilItems", ['id', 'seq'])
MasterDataManager.set_index_keys("mysekaiMaterials", ['id', 'seq'])
MasterDataManager.set_index_keys("customProfileTextColors", ['id'])
MasterDataManager.set_index_keys("customProfileTextFonts", ['id'])
MasterDataManager.set_index_keys("customProfileShapeResources", ['id'])
MasterDataManager.set_index_keys("customProfilePlayerInfoResources", ['id'])
MasterDataManager.set_index_keys("customProfileGeneralBackgroundResources", ['id'])
MasterDataManager.set_index_keys("customProfileStoryBackgroundResources", ['id'])
MasterDataManager.set_index_keys("customProfileMemberStandingPictureResources", ['id'])
MasterDataManager.set_index_keys("customProfileCollectionResources", ['id'])
MasterDataManager.set_index_keys("customProfileEtcResources", ['id'])
MasterDataManager.set_index_keys("customProfileCharacterIconResources", ['id'])
MasterDataManager.set_index_keys("customProfileMaterialResources", ['id'])
MasterDataManager.set_index_keys("customProfileUserInterfaceIconResources", ['id'])
MasterDataManager.set_index_keys("omikujis", ['id'])
MasterDataManager.set_index_keys("unitStoryEpisodeGroups", ['id'])
